...
function sqlForPartialUpdate(table, items, key, id) {
  ...
  // Not supposed to be adding new features right now, but for future reference
  // would want to implement below and reflect change to route: 
  // if (columns.length === 0) {
  //   throw new ExpressError("No data provided for update", 400);
  // }
